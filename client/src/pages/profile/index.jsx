           ...
           <div className="flex flex-col gap-10 w-[80vw] md:w-max">
                ...
                <div className="grid grid-cols-2">
                    <div className="h-full w-32 md:w-48 md:h-48 relative flex items-center justify-center" onMouseEnter={()=>setHovered(true)} onMouseLeave={()=> setHovered(false)}>
                        ...
                        {
                            hovered && 
                                (<div className="absolute inset-0 flex items-center bg-black/50 ring-fuchsia-50 rounded-full ">
                                    {
                        ...
                        <div className="w-full flex gap-5">
                            {
                                ...
                                ${selectedColor === index ? "outline outline-white/50" : ""}`} key={index} onClick={() => setSelectedColor(index)}></div>)
                            }
                        </div>
                    </div>
                </div>
